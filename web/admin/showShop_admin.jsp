...
<c:if test="${empty allpage}">
    <c:redirect url="/admin/ShowShopsServlet"></c:redirect>
</c:if>
<%
        ...
        <div class="nano-content">
            ...
            <ul>
                ...
                <li><a class="sidebar-sub-toggle"><i class="ti-layout"></i>shop<span class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
                        <li><a href="showShop_admin.jsp">show shops</a></li>
                        <li><a href="addShop_admin.jsp">add shops</a></li>
...
<div class="content-wrap">
    <div class="main">
        ...
        <a href="ShowShopsServlet?pagel=<%=curren-1<1?1:(curren-1)%>">last</a>
        <a><%=curren%>/</a>
        <a><%=allpage%></a>
        <a href="ShowShopsServlet?pagel=<%=curren+1>allpage?allpage:curren+1%>">next</a>
