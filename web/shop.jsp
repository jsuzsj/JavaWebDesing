...
<head>
    ...
    <c:if test="${empty sessionScope.shops_count}">
        <c:redirect url="/ShopsServlet"></c:redirect>
    </c:if>
    <%
        int per_page = 6;
                        ...
                        <div class="pagination">
                            <ul>
                                <c:forEach var="i" begin="1" end="<%=allcount%>">
                                    <li><a href="ShopsServlet?pagel=${i}">${i}</a></li>
                                </c:forEach>
                                <li class="next"><a href="ShopsServlet?pagel=<%=nowpage+1>allcount?allcount:nowpage+1%>">next</a></li>
                            </ul>
                        </div>
                    </div>
                    <!--shop toolbar end-->
