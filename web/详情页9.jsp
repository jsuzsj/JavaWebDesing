                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="assets/img/product/productbig001.jpg" data-zoom-image="assets/img/product/productbig001.jpg" alt="big-1">
                            </a>
                        </div>
                        <div class="single-zoom-thumb">
                            <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig001.jpg" data-zoom-image="assets/img/product/productbig001.jpg">
                                        <img src="assets/img/product/productbig001.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig002.jpg" data-zoom-image="assets/img/product/productbig002.jpg">
                                        <img src="assets/img/product/productbig002.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig003.jpg" data-zoom-image="assets/img/product/productbig003.jpg">
                                        <img src="assets/img/product/productbig003.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig004.jpg" data-zoom-image="assets/img/product/productbig004.jpg">
                                        <img src="assets/img/product/productbig004.jpg" alt="zo-th-1"/>
                                    </a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <h1><a href="#">真无线蓝牙耳机双耳运动跑步入耳式耳塞挂耳开车迷你超小隐形5.0苹果安卓手机通用防水x男女微小型头戴式xs</a></h1>
                            ...
                            <div class="tab-pane fade show active" id="info" role="tabpanel" >
                                <div class="product_info_content">
                                  <ul>
                                    <li> 品牌名称：兰士顿</li>
                                    <li>产品参数：</li>
                                    <li>产品名称：兰士顿 T10品牌: 兰士顿型号: T10</li>
                                    <li>功能: 通话功能耳机材质: 塑料产地: 中国大陆</li>
                                    <li>省份: 广东省地市: 深圳市声道: 2蓝牙版本: 5.0颜色分类: 黑色【升级5.0蓝牙、开机自动链接】套餐类型: 官方标配</li>
                                    <li>生产企业: 兰士顿使用方式: 入耳式传输半径: 10m是否单双耳: 双边立体声传输半径: 10m保修期: 12个月</li>
                                    <li>耳机左右腔体间连接方式: 无线连接耳机与播放设备连接方式: 蓝牙连接</li>
