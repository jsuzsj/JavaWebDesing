                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <h1><a href="#">Nike耐克新款男子NIKE M2K TEKNO老爹鞋</a></h1>
                            ...
                            <div class="tab-pane fade show active" id="info" role="tabpanel" >
                                <div class="product_info_content">
                                  <ul>
                                    <li> 品牌名称：Nike/耐克</li>
                                    <li>产品参数：</li>
                                    <li>产品名称：Nike/耐克 415445品牌: Nike/耐克功能: 平衡</li>
                                    <li>鞋码: 38.5 39 40 40.5 41 42 42.5 43 44 44.5 45 45.5 46 47.5</li>
                                    <li>颜色分类: 102白色/金属银/深藏青 100白色/白色/冷灰/荧光黄/煤黑 101白色/黑/校园红 103白色/金属金/幻影灰白/幸运绿/橡皮浅褐  吊牌价: 549</li>
                                    <li>款号: 415445上市时间: 2015年秋季适用场景: 休闲健步</li>
                                    <li>性别: 男子是否商场同款: 是</li>
