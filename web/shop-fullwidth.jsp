...
<c:if test="${empty sessionScope.shops_count}">
    <c:redirect url="/ForwardShopsServlet"></c:redirect>
</c:if>
<%
    int per_page = 6;
    int shops_count = (int) request.getSession().getAttribute("shops_count");
    int allcount =shops_count /per_page;
    if(shops_count%per_page!=0)
        allcount++;
                                     ...
                                     <figure>
                                         <div class="product_thumb">
                                             <div class="label_product">
                                                 ...
                                                 <c:if test="${shop.discount!=0}">
                                                     <span class="label_sale">${shop.discount}%</span>
                                                 </c:if>

                                             </div>
                                             <a class="secondary_img" href="详情页2.jsp"><img src="assets/img/product/"${shop.desc} alt=""></a>
                                             ...
                                             <a class="primary_img" href="详情页2.jsp"><img src="assets/img/product/${shop.desc}" alt=""></a>                                    </div>
                                         <div class="product_content grid_content">
                                             ...
                                             <h4 class="product_name"><a href="详情页2.jsp">${shop.name}</a></h4>
                                             <div class="price_box">
                                                 <span class="current_price">￥${shop.price}</span>
                                                 <span class="old_price">￥${shop.price}</span>
                                             </div>
                                             <div class="add_to_cart" >
                                                 <a onclick="ajax1(${shop.id});" href="#" shopid="${shop.id}" title="加入购物车">加入购物车</a>
                                             </div>
...
<%--                                            <span class="label_sale">10%</span>--%>
<%--                                        </div>--%>
<%--                                        <a class="primary_img" href="详情页5.jsp"><img src="assets/img/product/product11.jpg" alt=""></a>--%>
<%--                                        <a class="secondary_img" href="详情页5.jsp"><img src="assets/img/product/product12.jpg" alt=""></a>--%>
<%--                                        <div class="action_links">--%>
<%--                                            <ul>--%>
<%--                                                <li class="quick_button"><a href="#" data-toggle="modal" data-target="#modal_box"  title="快速视图"> <i class="icon icon-Eye"></i></a></li>--%>
<%--                                                <li class="wishlist"><a href="wishlist.html" title="喜欢"><i class="icon icon-Heart"></i></a></li>  --%>
...
<%--                                            <span class="label_new">new</span>--%>
<%--                                        </div>--%>
<%--                                        <a class="primary_img" href="详情页6 .jsp"><img src="assets/img/product/product19.jpg" alt=""></a>--%>
<%--                                        <a class="secondary_img" href="详情页6 .jsp"><img src="assets/img/product/product20.jpg" alt=""></a>--%>
<%--                                        <div class="action_links">--%>
<%--                                            <ul>--%>
<%--                                                <li class="quick_button"><a href="#" data-toggle="modal" data-target="#modal_box"  title="快速视图"> <i class="icon icon-Eye"></i></a></li>--%>
<%--                                                <li class="wishlist"><a href="wishlist.html" title="喜欢"><i class="icon icon-Heart"></i></a></li>  --%>
...
<%--                                           </ul>--%>
<%--                                        </div>--%>
<%--                                        <h4 class="product_name"><a href="详情页6 .jsp">CONVERSE匡威1970S三星标浅蓝色高帮低帮男女休闲帆布板鞋酷动城正品</a></h4>--%>
<%--                                        <div class="price_box"> --%>
...
<%--                                            <span class="label_sale">10%</span>--%>
<%--                                        </div>--%>
<%--                                        <a class="primary_img" href="详情页7.jsp"><img src="assets/img/product/product13.jpg" alt=""></a>--%>
...
<%--                                           </ul>--%>
<%--                                        </div>--%>
<%--                                        <h4 class="product_name"><a href="详情页7.jsp">CONVERSE匡威1970S三星标白色高帮低帮男女休闲帆布板鞋酷动城正品</a></h4>--%>
<%--                                        <div class="price_box"> --%>
...
<%--                                            <span class="label_sale">10%</span>--%>
<%--                                        </div>--%>
<%--                                        <a class="primary_img" href="详情页8.jsp"><img src="assets/img/product/product20.jpg" alt=""></a>--%>
<%--                                        <a class="secondary_img" href="详情页8.jsp"><img src="assets/img/product/product21.jpg" alt=""></a>--%>
<%--                                        <div class="action_links">--%>
<%--                                            <ul>--%>
<%--                                                <li class="quick_button"><a href="#" data-toggle="modal" data-target="#modal_box"  title="快速视图"> <i class="icon icon-Eye"></i></a></li>--%>
<%--                                                <li class="wishlist"><a href="wishlist.html" title="喜欢"><i class="icon icon-Heart"></i></a></li>  --%>
...
<%--                                           </ul>--%>
<%--                                        </div>--%>
<%--                                        <h4 class="product_name"><a href="详情页8.jsp">CONVERSE匡威1970S三星标橙色高帮低帮男女休闲帆布板鞋酷动城正品</a></h4>--%>
<%--                                        <div class="price_box"> --%>
<%--                                            <span class="current_price">￥335.00</span>--%>
<%--                                            <span class="old_price">￥345.00</span>--%>
<%--                                        </div>--%>
...
<%--                        </div>--%>
                    ...
                    <div class="shop_toolbar t_bottom">
                        <div class="pagination">
                            <ul>
                                <c:forEach var="i" begin="1" end="<%=allcount%>">
                                    <li><a href="ForwardShopsServlet?pagel=${i}">${i}</a></li>
                                </c:forEach>
                                <li class="next"><a href="ForwardShopsServlet?pagel=<%=nowpage+1>allcount?allcount:nowpage+1%>">next</a></li>
                            </ul>
                        </div>
                    </div>
                    <!--shop toolbar end-->
