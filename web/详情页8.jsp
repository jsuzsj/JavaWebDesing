                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="assets/img/product/productbig013.jpg" data-zoom-image="assets/img/product/productbig013.jpg" alt="big-1">
                            </a>
                        </div>
                        <div class="single-zoom-thumb">
                            <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig013.jpg" data-zoom-image="assets/img/product/productbig013.jpg">
                                        <img src="assets/img/product/productbig013.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig014.jpg" data-zoom-image="assets/img/product/productbig014.jpg">
                                        <img src="assets/img/product/productbig014.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig015.jpg" data-zoom-image="assets/img/product/productbig015.jpg">
                                        <img src="assets/img/product/productbig015.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig016.jpg" data-zoom-image="assets/img/product/productbig016.jpg">
                                        <img src="assets/img/product/productbig016.jpg" alt="zo-th-1"/>
                                    </a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <h1><a href="#">CONVERSE匡威经典Chuck Taylor 1970高帮帆布鞋</a></h1>
                            ...
                            <div class="product_meta">
                                <span>品牌: <a href="#">Converse/匡威</a></span>
                            </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="info" role="tabpanel" >
                                <div class="product_info_content">
                                  <ul>
                                    <li> 品牌名称：Converse/匡威</li>
                                    <li>产品参数：</li>
                                    <li>产品名称：Converse/匡威 SH0890品牌: Converse/匡威</li>
                                    <li>鞋码: 38.5 39 40 40.5 41 42 42.5 43 44 44.5 45 45.5 46 47.5</li>
                                    <li>颜色分类: 黄色/162050C吊牌价: 569</li>
                                    <li>上市时间: 2018年春季鞋帮高度: 高帮性别: 男女通用</li>
                                    <li>是否商场同款: 是</li>
                                </ul>
