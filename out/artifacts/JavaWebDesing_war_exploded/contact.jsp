            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                   <div class="contact_message content">
                        <h3>联系作者</h3>    
                         <p>"Nunoah男鞋"竭诚为您服务，欢迎来访！</p>
                        <ul>
                            <li><i class="fa fa-fax"></i>  地址 :湖南大众传媒职业技术学院电子商务技术1801</li>
                            <li><i class="fa fa-phone"></i> <a href="#">18670627107</a></li>
                            <li><i class="fa fa-envelope-o"></i><a href="tel:0(1234)567890">1598950239@qq.com</a>  </li>
                        </ul>             
                    </div> 
                </div>
                <div class="col-lg-6 col-md-12">
                   <div class="contact_message form">
                        ...
                        <form id="contact-form" method="POST"  action="assets/mail.php">
                            <p>  
                               <label>您的姓名</label>
                                <input name="姓名" placeholder="姓名 *" type="text"> 
                            </p>
                            <p>       
                               <label>您的email</label>
                            ...
                            <p>          
                               <label>您的反馈</label>
                                <input name="反馈" placeholder="反馈 *" type="text">
                            </p>    
                            <div class="contact_textarea">
                                <label>您的留言</label>
                                <textarea placeholder="留言" name="留言 *"  class="form-control2" ></textarea>     
                            </div>   
