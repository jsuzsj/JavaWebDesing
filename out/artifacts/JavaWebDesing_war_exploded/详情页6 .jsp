                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="assets/img/product/productbig05.jpg" data-zoom-image="assets/img/product/productbig05.jpg" alt="big-1">
                            </a>
                        </div>
                        <div class="single-zoom-thumb">
                            <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig05.jpg" data-zoom-image="assets/img/product/productbig05.jpg">
                                        <img src="assets/img/product/productbig05.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig06.jpg" data-zoom-image="assets/img/product/productbig06.jpg">
                                        <img src="assets/img/product/productbig06.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig07.jpg" data-zoom-image="assets/img/product/productbig07.jpg">
                                        <img src="assets/img/product/productbig07.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig08.jpg" data-zoom-image="assets/img/product/productbig08.jpg">
                                        <img src="assets/img/product/productbig08.jpg" alt="zo-th-1"/>
                                    </a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <h1><a href="#">CONVERSE匡威1970S三星标白高帮低帮男女休闲帆布板鞋酷动城正品</a></h1>
