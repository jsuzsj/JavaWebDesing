                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="assets/img/product/productbig9.jpg" data-zoom-image="assets/img/product/productbig9.jpg" alt="big-1">
                            </a>
                        </div>
                        <div class="single-zoom-thumb">
                            <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig9.jpg" data-zoom-image="assets/img/product/productbig9.jpg">
                                        <img src="assets/img/product/productbig9.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig10.jpg" data-zoom-image="assets/img/product/productbig10.jpg">
                                        <img src="assets/img/product/productbig10.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig11.jpg" data-zoom-image="assets/img/product/productbig11.jpg">
                                        <img src="assets/img/product/productbig11.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig12.jpg" data-zoom-image="assets/img/product/productbig12.jpg">
                                        <img src="assets/img/product/productbig12.jpg" alt="zo-th-1"/>
                                    </a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <h1><a href="#">Nike耐克官方NIKE AIR FORCE 1 '07男子运动鞋空军一号板鞋！</a></h1>
                            ...
                            <div class="tab-pane fade show active" id="info" role="tabpanel" >
                                <div class="product_info_content">
                                  <ul>
                                    <li> 品牌名称：Nike/耐克</li>
                                    <li>产品参数：</li>
                                    <li>产品名称：Nike/耐克 315122品牌: Nike/耐克功能: 耐磨</li>
                                    <li>鞋码: 38.5 39 40 40.5 41 42 42.5 43 44 44.5 45 45.5 46 47.5</li>
                                    <li>颜色分类: 111白/白 001黑/黑吊牌价: 749起</li>
                                    <li>款号: 315122上市时间: 2016年秋季鞋帮高度: 低帮</li>
                                    <li>性别: 男子帮面材质: 其他是否商场同款: 是</li>
                            ...
                            <figure>
                                <div class="product_thumb">
                                   <div class="label_product">
                                    ...
                                    <a class="primary_img" href="详情页3.sjp"><img src="assets/img/product/product5.jpg" alt=""></a>
                                    <a class="secondary_img" href="详情页3.sjp"><img src="assets/img/product/product6.jpg" alt=""></a>
                                ...
                                <figcaption class="product_content">
                                    ...
                                    <h4 class="product_name"><a href="详情页3.sjp">Nike耐克官方NIKE AIR FORCE 1 '07男子运动鞋空军一号板鞋！</a></h4>
                                    <div class="price_box"> 
                                        <span class="current_price">￥749.00</span>
                                        <span class="old_price">￥799.00</span>
                                    </div>
