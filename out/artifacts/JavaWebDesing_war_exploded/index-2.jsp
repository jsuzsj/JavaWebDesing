                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <figure class="single_banner">
                        <div class="banner_thumb">
                            <a href="shop.jsp"><img src="assets/img/bg/banner4.jpg" alt=""></a>
                        </div>
                    </figure>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <figure class="single_banner">
                        <div class="banner_thumb">
                            <a href="shop.jsp"><img src="assets/img/bg/banner5.jpg" alt=""></a>
                        </div>
                    </figure>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <figure class="single_banner">
                        <div class="banner_thumb">
                            <a href="shop.jsp"><img src="assets/img/bg/banner6.jpg" alt=""></a>
                        </div>
                    </figure>
                </div>
            </div>
                            ...
                            <figure>
                                <div class="product_thumb">
                                   <div class="label_product">
                                    ...
                                    <a class="primary_img" href="详情页5.jsp"><img src="assets/img/product/product11.jpg" alt=""></a><a class="secondary_img" href="详情页5.jsp"><img src="assets/img/product/product12.jpg" alt=""></a>
                                ...
                                <figcaption class="product_content">
                                    ...
                                    <h4 class="product_name"><a href="详情页5.jsp">CONVERSE匡威1970S三星标黑高帮低帮男女休闲帆布板鞋酷动城正品</a></h4>
                                    <div class="price_box"> 
                                        <span class="current_price">￥439.00</span>
                                        <span class="old_price">￥459.00</span>
                                    </div>
                                    <div class="add_to_cart">
                                        <a href="cart.jsp" title="Add to cart">加入购物车</a>
                                    </div>
                            ...
                            <figure>
                                <div class="product_thumb">
                                   <div class="label_product">
                                    ...
                                    <a class="primary_img" href="详情页6 .jsp"><img src="assets/img/product/product13.jpg" alt=""></a>
                                    <a class="secondary_img" href="详情页6 .jsp"><img src="assets/img/product/product14.jpg" alt=""></a>
                                    <div class="action_links">
                                        <ul>
                                            <li class="quick_button"><a href="#" data-toggle="modal" data-target="#modal_box"  title="快速视图"> <i class="icon icon-Eye"></i></a></li>
                                            <li class="wishlist"><a href="wishlist.html" title="喜欢"><i class="icon icon-Heart"></i></a></li>  
                                ...
                                <figcaption class="product_content">
                                    ...
                                    <h4 class="product_name"><a href="详情页6 .jsp"> CONVERSE匡威1970S三星标白高帮低帮男女休闲帆布板鞋酷动城正品</a></h4>
                                    <div class="price_box"> 
                            ...
                            <figure>
                                <div class="product_thumb">
                                   <div class="label_product">
                                    ...
                                    <a class="primary_img" href="详情页7.jsp"><img src="assets/img/product/product15.jpg" alt=""></a>
                                    <a class="secondary_img" href="详情页7.jsp"><img src="assets/img/product/product16.jpg" alt=""></a>
                                    <div class="action_links">
                                        <ul>
                                            <li class="quick_button"><a href="#" data-toggle="modal" data-target="#modal_box"  title="快速视图"> <i class="icon icon-Eye"></i></a></li>
                                            <li class="wishlist"><a href="wishlist.html" title="喜欢"><i class="icon icon-Heart"></i></a></li>  
                                ...
                                <figcaption class="product_content">
                                    ...
                                    <h4 class="product_name"><a href="详情页7.jsp">Fear of God Converse匡威Chuck70联名FOG花纹高帮帆布鞋</a></h4>
                                    <div class="price_box"> 
                            ...
                            <figure>
                                <div class="product_thumb">
                                   <div class="label_product">
                                    ...
                                    <a class="primary_img" href="详情页8.jsp"><img src="assets/img/product/product17.jpg" alt=""></a>
                                    <a class="secondary_img" href="详情页8.jsp"><img src="assets/img/product/product18.jpg" alt=""></a>
                                    <div class="action_links">
                                        <ul>
                                            <li class="quick_button"><a href="#" data-toggle="modal" data-target="#modal_box"  title="快速视图"> <i class="icon icon-Eye"></i></a></li>
                                            <li class="wishlist"><a href="wishlist.html" title="喜欢"><i class="icon icon-Heart"></i></a></li>  
                                ...
                                <figcaption class="product_content">
                                    ...
                                    <h4 class="product_name"><a href="详情页8.jsp">CONVERSE匡威经典Chuck Taylor 1970高帮帆布鞋</a></h4>
                                    <div class="price_box"> 
                        ...
                        <article class="single_product">
                            <figure>
                                ...
                                <figcaption class="product_content">
                                    ...
                                    <h4 class="product_name"><a href="product-details.jsp">CONVERSE匡威1970s高帮三星标男鞋女鞋休闲帆布鞋黄色</a></h4>
                                    <div class="price_box"> 
                                        <span class="current_price">￥420.00</span>
                                ...
                                <article class="single_product">
                                    <figure>
                                        ...
                                        <figcaption class="product_content">
                                            ...
                                            <h4 class="product_name"><a href="product-details.jsp">CONVERSE匡威1970s高帮三星标男鞋女鞋休闲帆布鞋!</a></h4>
                                            <div class="price_box"> 
                                                <span class="current_price">￥420.00</span>
                                                <span class="old_price">￥430.00</span>
                                            </div>
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                           <div class="label_product">
                                            ...
                                            <a class="primary_img" href="product-details.jsp"><img src="assets/img/product/product16.jpg" alt=""></a>
                                            <a class="secondary_img" href="product-details.jsp"><img src="assets/img/product/product15.jpg" alt=""></a>
                                            <div class="action_links">
                                                <ul>
                                                    <li class="quick_button"><a href="#" data-toggle="modal" data-target="#modal_box"  title="快速视图"> <i class="icon icon-Eye"></i></a></li>
                                                    <li class="wishlist"><a href="wishlist.html" title="喜欢"><i class="icon icon-Heart"></i></a></li>  
                                    ...
                                    <figure>
                                        <div class="product_thumb">
                                           <div class="label_product">
                                            ...
                                            <a class="primary_img" href="product-details.jsp"><img src="assets/img/product/product14.jpg" alt=""></a>
                                            <a class="secondary_img" href="product-details.jsp"><img src="assets/img/product/product20.jpg" alt=""></a>
                                            <div class="action_links">
                                                <ul>
                                                    <li class="quick_button"><a href="#" data-toggle="modal" data-target="#modal_box"  title="快速视图"> <i class="icon icon-Eye"></i></a></li>
