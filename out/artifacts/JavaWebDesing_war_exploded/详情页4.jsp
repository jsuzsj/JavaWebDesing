                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-tab">
                        <div id="img-1" class="zoomWrapper single-zoom">
                            <a href="#">
                                <img id="zoom1" src="assets/img/product/productbig13.jpg" data-zoom-image="assets/img/product/productbig13.jpg" alt="big-1">
                            </a>
                        </div>
                        <div class="single-zoom-thumb">
                            <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                <li>
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig13.jpg" data-zoom-image="assets/img/product/productbig13.jpg">
                                        <img src="assets/img/product/productbig13.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig14.jpg" data-zoom-image="assets/img/product/productbig14.jpg">
                                        <img src="assets/img/product/productbig14.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig15.jpg" data-zoom-image="assets/img/product/productbig15.jpg">
                                        <img src="assets/img/product/productbig15.jpg" alt="zo-th-1"/>
                                    </a>

                                </li>
                                <li >
                                    <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/img/product/productbig16.jpg" data-zoom-image="assets/img/product/productbig16.jpg">
                                        <img src="assets/img/product/productbig16.jpg" alt="zo-th-1"/>
                                    </a>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                       <form action="#">
                            ...
                            <h1><a href="#">耐克Air Force 1 AF1空军一号纯白男女高帮板鞋！</a></h1>
                            ...
                            <div class="tab-pane fade show active" id="info" role="tabpanel" >
                                <div class="product_info_content">
                                  <ul>
                                    <li> 品牌名称：Nike/耐克</li>
                                    <li>产品参数：</li>
                                    <li>产品名称：Nike/耐克 315123品牌: Nike/耐克功能: 耐磨</li>
                                    <li>鞋码: 38.5 39 40 40.5 41 42 42.5 43 44 44.5 45 45.5 46 47.5</li>
                                    <li>颜色分类: 102白色/金属银/深藏青 100白色/白色/冷灰/荧光黄/煤黑 101白色/黑/校园红 103白色/金属金/幻影灰白/幸运绿/橡皮浅褐  吊牌价: 799</li>
                                    <li>款号: 315123上市时间: 2016年冬季鞋帮高度: 中帮</li>
                                    <li>性别: 男子是否商场同款: 是</li>
